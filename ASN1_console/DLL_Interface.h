...
#define DLL_FUNCTION_POINTER(name) \
  ...
  bool Check_##name() { return (ASN1_##name##_New && ASN1_##name##_Get##name##Value && ASN1_##name##_Set##name##Value \
...
#define DLL_NODE_TYPE(name, type) \
  ...
  bool LoadASN1DLL(const std::wstring& dllPath) {
    ...
    if (!ByteArray_New || !ByteArray_NewFromByteArray || !ByteArray_Delete || !ByteArray_Size
        || !ByteArray_Equals || !ByteArray_GetString || !ByteArray_GetByteAtRank || !ByteArray_GetBytesAtRank
        || !ByteArray_Clear || !ByteArray_Append || !ByteArray_InsertAt) return false;
    if (!Utils_IntAsHex || !Utils_HexAsInt || !Utils_BinaryAsHex || !Utils_HexAsBinary
        || !Utils_HexAsBinary8Padded || !Utils_IntAsBinary || !Utils_IntAsBinary8Padded || !Utils_BinaryAsInt
        || !Utils_IsHex || !Utils_IsBinary || !Utils_IsComplexType || !Utils_GetTagFromBuffer || !Utils_GetLengthFromBuffer
        || !Utils_MakeLength || !Utils_MakeTag || !Utils_DecomposeTag || !Utils_StringToHex
        || !Utils_HexToString || !Utils_UTCTimeToValues || !Utils_ValuesToUTCTime || !Utils_IsValidObjectID || !Utils_IsValidUTCTime
        || !Utils_IsValidIA5String || !Utils_IsValidUTF8String) return false;
    if (!ASN1_Object_GetMyOwner || !ASN1_Object_GetDefaultValue || !ASN1_Object_GetDefaultTag || !ASN1_Object_GetTag
        || !ASN1_Object_GetDescription || !ASN1_Object_StringExtract || !ASN1_Object_StringExtractForResearch || !ASN1_Object_GetType
        || !ASN1_Object_IsMandatory || !ASN1_Object_IsIgnored || !ASN1_Object_IsExplicit || !ASN1_Object_GetHexBuffer || !ASN1_Object_GetLastSize
        || !ASN1_Object_ClearDynamicData || !ASN1_Object_SetDescription || !ASN1_Object_Ignore || !ASN1_Object_WriteIntoBuffer
        || !ASN1_Object_ReadFromBuffer || !ASN1_Object_Compare || !ASN1_Object_Delete) return false;
    if (!ASN1_Choice_New || !ASN1_Choice_AvailableChoices || !ASN1_Choice_GetChoiceFromIndex || !ASN1_Choice_MakeDummyChoiceList
        || !ASN1_Choice_DeleteDummyChoiceList || !ASN1_Choice_SetSelectedChoice || !ASN1_Choice_GetSelectedChoice || !ASN1_Choice_GetSelectedChoiceIndex) return false;
    if (!ASN1_Sequence_New || !ASN1_Sequence_GetObjectAt || !ASN1_Sequence_GetSize
        || !ASN1_Sequence_GetExtensibilityObjectAt || !ASN1_Sequence_GetExtensibilitySize || !ASN1_Sequence_IsExtensible) return false;
    if (!ASN1_SequenceOf_New || !ASN1_SequenceOf_GetObjectAt || !ASN1_SequenceOf_GetSize || !ASN1_SequenceOf_AppendNewObject
        || !ASN1_SequenceOf_DeleteObjectAt || !ASN1_SequenceOf_MoveUpObject || !ASN1_SequenceOf_MoveDownObject || !ASN1_SequenceOf_GetDummyNewObject) return false;
    if (!ASN1_Set_New || !ASN1_Set_GetObjectAt || !ASN1_Set_GetSize
        || !ASN1_Set_GetExtensibilityObjectAt || !ASN1_Set_GetExtensibilitySize || !ASN1_Set_IsExtensible) return false;
    if (!Check_BitString() || !Check_Boolean() || !Check_Enumerated() || !Check_IA5String() || !Check_Integer()
        || !Check_Null() || !Check_OctetString() || !Check_ObjectID() || !Check_Real() || !Check_UTCTime() || !Check_UTF8String()) return false;
