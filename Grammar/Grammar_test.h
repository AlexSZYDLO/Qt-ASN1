...
namespace Grammar {
  ...
  ASN1_Choice* MakeChoiceTest(const char* name, ByteArray tag) {
    ASN1_Choice::callbackChoice callback{
      [](unsigned int idx, void*) -> ASN1_Object* {
        switch (idx) {
        case 0: return new ASN1_Integer("choice integer a", "0A");
        case 1: return new ASN1_Integer("choice integer b", "0B");
        case 2: return new ASN1_Integer("choice integer c", "0C");
  ...
  ASN1_Sequence* MakeSequenceTest(const char* name, ByteArray tag, SequenceTestVars& vars) {
    ...
    ASN1_Object* arr[12] = { vars.a, vars.b, vars.c, vars.d, vars.e, vars.f, vars.g, vars.h, vars.i, vars.j, vars.k, vars.l };
  ...
  ASN1_SequenceOf* MakeSequenceOfTest(const char* name, ByteArray tag) {
    ASN1_SequenceOf::callbackSequenceOf callback{
      [](void*)-> ASN1_Object* {return new ASN1_Integer("int in seq of"); },
      nullptr
    };
