...
void Utils_UTCTimeToValues(const char *input,
                           int *year_YY,
                           int *month_MM,
                           int *day_DD,
                           int *hours_HH,
                           ...
                           unsigned int errorBufferSize)
{
  ...
  Utils::UTCTimeToValues(
      input, *year_YY, *month_MM, *day_DD, *hours_HH, *minutes_MM, *seconds_SS, z, *zoneHours_HH, *zoneMinutes_MM, errorStr);
  *zone = static_cast<unsigned int>(z);
  StringToBuffer(errorStr, error, errorBufferSize);
}

void Utils_ValuesToUTCTime(int year_YY,
                           int month_MM,
                           int day_DD,
                           int hours_HH,
                           int minutes_MM,
                           ...
                           unsigned int errorBufferSize)
{
  ...
  Utils::ValuesToUTCTime(year_YY,
                         month_MM,
                         day_DD,
                         hours_HH,
                         minutes_MM,
                         seconds_SS,
                         static_cast<Utils::eUTCTimeZone>(zone),
                         zoneHours_HH,
                         zoneMinutes_MM,
                         outStr,
                         errorStr);
...
bool ASN1_Object_ReadFromBuffer(ASN1_Object *obj, const ByteArray *buffer, char *error, unsigned int errorBufferSize)
{
  return obj->ReadFromBuffer(*buffer, error, errorBufferSize);
}

bool ASN1_Object_Compare(const ASN1_Object *obj,
...
// ------------ ASN1_CHOICE ------------
ASN1_Choice *ASN1_Choice_New(ASN1_Choice::callbackChoice choiceFromIdx,
...
// ------------ ASN1_SEQUENCE ------------
ASN1_Sequence *ASN1_Sequence_New(ASN1_Object *valuesArray[],
...
// ------------ ASN1_SEQUENCEOF ------------
ASN1_SequenceOf *ASN1_SequenceOf_New(ASN1_SequenceOf::callbackSequenceOf newSeqOfObject,
                                     const char *name,
                                     const ByteArray *tag,
                                     bool optional,
                                     bool explicitTag,
...
// ------------ ASN1_SET ------------
ASN1_Set *ASN1_Set_New(ASN1_Object *valuesArray[],
                       unsigned int numberOfValues,
                       const char *name,
                       const ByteArray *tag,
                       bool optional,
