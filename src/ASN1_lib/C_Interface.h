...
#define NODE_CONSTRUCTOR_FUNCTION(name)                                                                                \
  MODULE_API ASN1_##name *ASN1_##name##_New(                                                                           \
...
#define NODE_SET_FUNCTION(name, type) MODULE_API void ASN1_##name##_Set##name##Value(ASN1_##name *obj, const type val);
#endif

#ifndef NODE_SET_CHECK_FUNCTION
#define NODE_SET_CHECK_FUNCTION(name, type)                                                                            \
  MODULE_API void ASN1_##name##_Set##name##ValueCheck(                                                                 \
      ASN1_##name *obj, const type val, char *errorBuffer, unsigned int errorBufferSize);
#endif

#ifndef NODE_GET_FUNCTION
#define NODE_GET_FUNCTION(name, type) MODULE_API void ASN1_##name##_Get##name##Value(const ASN1_##name *obj, type *out);
#endif
...
#define NODE_CONVERT_HEX_TO_TYPE(name, type)                                                                           \
  MODULE_API void ASN1_##name##_HexTo##name(                                                                           \
...
#define NODE_CONVERT_HEX_TO_TYPE_WITH_BUFFER(name)                                                                     \
  MODULE_API void ASN1_##name##_HexTo##name(const ByteArray *input,                                                    \
                                            char *output,                                                              \
...
#define NODE_CONVERT_TYPE_TO_HEX(name, type)                                                                           \
  MODULE_API void ASN1_##name##_##name##ToHex(                                                                         \
...
MODULE_API bool
ByteArray_GetBytesAtRank(const ByteArray *hex, unsigned int firstByteRank, unsigned int nbOfBytes, ByteArray *out);
...
MODULE_API bool
Utils_DecomposeTag(const ByteArray *tag, unsigned int *tagClass, unsigned int *tagForm, ByteArray *label);
...
MODULE_API void Utils_UTCTimeToValues(const char *input,
                                      int *year_YY,
                                      int *month_MM,
                                      int *day_DD,
                                      int *hours_HH,
                                      ...
                                      char *error,
                                      unsigned int errorBufferSize);
MODULE_API void Utils_ValuesToUTCTime(int year_YY,
                                      int month_MM,
                                      int day_DD,
                                      int hours_HH,
                                      int minutes_MM,
...
MODULE_API bool
ASN1_Object_ReadFromBuffer(ASN1_Object *obj, const ByteArray *buffer, char *errorBuffer, unsigned int errorBufferSize);
MODULE_API bool ASN1_Object_Compare(const ASN1_Object *obj,
                                    const ASN1_Object *secondTree,
...
//  void* context;
//};
MODULE_API ASN1_Choice *ASN1_Choice_New(ASN1_Choice::callbackChoice choiceFromIdx,
                                        unsigned int maxChoiceIdx,
                                        const char *name,
                                        const ByteArray *tag,
                                        bool optional,
                                        bool explicitTag,
                                        const ASN1_Choice *defaultValue);
...
// ------------ ASN1_SEQUENCE ------------
MODULE_API ASN1_Sequence *ASN1_Sequence_New(ASN1_Object *valuesArray[],
                                            unsigned int numberOfValues,
                                            const char *name,
                                            const ByteArray *tag,
                                            bool optional,
                                            bool explicitTag,
                                            const ASN1_Sequence *defaultValue,
                                            bool extensibility);
...
//  void* context;
//};
MODULE_API ASN1_SequenceOf *ASN1_SequenceOf_New(ASN1_SequenceOf::callbackSequenceOf newSeqOfObject,
                                                const char *name,
                                                const ByteArray *tag,
                                                bool optional,
                                                bool explicitTag,
                                                const ASN1_SequenceOf *defaultValue);
...
// ------------ ASN1_SET ------------
MODULE_API ASN1_Set *ASN1_Set_New(ASN1_Object *valuesArray[],
                                  unsigned int numberOfValues,
                                  const char *name,
                                  const ByteArray *tag,
                                  bool optional,
                                  bool explicitTag,
                                  const ASN1_Set *defaultValue,
                                  bool extensibility);
