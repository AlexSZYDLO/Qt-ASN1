...
public:
  ...
  MODULE_API ByteArray(const std::string &str = "");
...
inline bool operator==(const ByteArray &hexStr, const ByteArray &hexStr2)
{
  return hexStr.m_HexValue == hexStr2.m_HexValue;
}
inline bool operator!=(const ByteArray &hexStr, const ByteArray &hexStr2)
{
  return !(hexStr == hexStr2);
}
