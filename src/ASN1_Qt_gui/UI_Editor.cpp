...
UI_Editor::UI_Editor(UI_Main *main)
    : QWidget(main)
    , m_Main(main)
    , m_Grammar(nullptr)
{
...
{
  QString fileName = QFileDialog::getOpenFileName(this, "Open Hexadecimal File", "", "Hexadecimal file (*.der *)");
  QFile f(fileName);
...
{
  QString fileName = QFileDialog::getOpenFileName(this, "Open ASN File", "", "Grammar file (*.asn *)");
  if (!fileName.isEmpty())
  {
    QFile f(fileName);
    if (f.open(QFile::ReadOnly))
    {
      ...
      m_Main->SetStatus("Failed to open the file.");
  }
}
...
{
  QString fileName = QFileDialog::getSaveFileName(this, "Save Hexadecimal File", "", "Hexadecimal files (*.der)");
  QFile f(fileName);
...
void UI_Editor::action_ConvertBitString()
{
  ShowConv<UI_ASN1_Converter_BitString>(this);
}
void UI_Editor::action_ConvertBoolean()
{
  ShowConv<UI_ASN1_Converter_Boolean>(this);
}
void UI_Editor::action_ConvertEnumerated()
{
  ShowConv<UI_ASN1_Converter_Enumerated>(this);
}
void UI_Editor::action_ConvertIA5String()
{
  ShowConv<UI_ASN1_Converter_IA5String>(this);
}
void UI_Editor::action_ConvertInteger()
{
  ShowConv<UI_ASN1_Converter_Integer>(this);
}
void UI_Editor::action_ConvertObjectID()
{
  ShowConv<UI_ASN1_Converter_ObjectID>(this);
}
void UI_Editor::action_ConvertOctetString()
{
  ShowConv<UI_ASN1_Converter_OctetString>(this);
}
void UI_Editor::action_ConvertReal()
{
  ShowConv<UI_ASN1_Converter_Real>(this);
}
void UI_Editor::action_ConvertUTCTime()
{
  ShowConv<UI_ASN1_Converter_UTCTime>(this);
}
void UI_Editor::action_ConvertUTF8String()
{
  ShowConv<UI_ASN1_Converter_UTF8String>(this);
}
