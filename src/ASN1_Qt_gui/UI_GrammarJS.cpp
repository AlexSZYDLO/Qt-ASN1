...
UI_GrammarJS::UI_GrammarJS(UI_Main *main)
    : QWidget(main)
    , m_Main(main)
    , m_JSDebug(false)
{
...
void MakeJSHintList(QStandardItemModel *model)
{
  ...
  // Root
  subList = {
      new DraggableStandardItem(
          "ClearDynamicData()", "Clears instances in sequence_of and reset choice nodes", "void ClearDynamicData()"),
      new DraggableStandardItem("registerGrammar()", "Makes the node the root node", "void registerGrammar()"),
      new DraggableStandardItem(
          "setDescription()", "Only a description, not part of ASN1 standard", "void setDescription(string description)"),
      new DraggableStandardItem("setIgnoredByUser()",
                                "If the node is optional, the node is ignored",
                                "void setIgnoredByUser(bool ignore [<i>=true</i>])")};
  current = new DraggableStandardItem(
      "Common Node ASN1", "Absrtact - Generic functions applicable to any node", "Not draggable", "", false);
  current->appendColumn(subList);
  itemList.push_back(current);

  // Bit String
  subList.clear();
  subList = {new DraggableStandardItem("getBitStringValue()", "Get the bitstring value.", "string getBitStringValue()"),
             new DraggableStandardItem(
                 "setBitStringValue()", "Set the bitstring value.", "void setBitStringValue(string value)")};
  current = new DraggableStandardItem(
      "BitStringASN1()",
      "ASN1 BitString node constructor. To be used with 'new'.",
  ...
  current = new DraggableStandardItem(
      "BooleanASN1()",
      "ASN1 Boolean node constructor. To be used with 'new'.",
  ...
  // Enum
  subList.clear();
  subList = {new DraggableStandardItem("getEnumeratedValue()", "Get the enumerated value.", "int getEnumeratedValue()"),
             new DraggableStandardItem(
                 "setEnumeratedValue()", "Set the enumerated value.", "void setEnumeratedValue(int value)")};
  current = new DraggableStandardItem(
      "EnumeratedASN1()",
      "ASN1 Enumerated node constructor. To be used with 'new'.",
  ...
  // IA5 String
  subList.clear();
  subList = {new DraggableStandardItem("getIA5StringValue()", "Get the ia5 string value.", "string getIA5StringValue()"),
             new DraggableStandardItem(
                 "setIA5StringValue()", "Set the ia5 string value.", "void setIA5StringValue(string value)")};
  current = new DraggableStandardItem(
      "IA5StringASN1()",
      "ASN1 IA5String node constructor. To be used with 'new'.",
  ...
  current = new DraggableStandardItem(
      "IntegerASN1()",
      "ASN1 Integer node constructor. To be used with 'new'.",
  ...
  // Object ID
  subList.clear();
  subList = {new DraggableStandardItem("getObjectIDValue()", "Get the object ID value.", "string getObjectIDValue()"),
             new DraggableStandardItem(
                 "setObjectIDValue()", "Set the object ID value.", "void setObjectIDValue(string value)")};
  current = new DraggableStandardItem(
      "ObjectIDASN1()",
      "ASN1 ObjectID node constructor. To be used with 'new'.",
  ...
  subList = {
      ...
      new DraggableStandardItem(
          "setOctetStringValue()", "Set the octet string value.", "void setOctetStringValue(string value)")};
  current = new DraggableStandardItem(
      "OctetStringASN1()",
      "ASN1 OctetString node constructor. To be used with 'new'.",
  ...
  // Real
  subList.clear();
  subList = {new DraggableStandardItem("getRealValue()", "Get the real value.", "double getRealValue()"),
             new DraggableStandardItem("setRealValue()", "Set the real value.", "void setRealValue(double value)")};
  current = new DraggableStandardItem(
      "RealASN1()",
      "ASN1 Real node constructor. To be used with 'new'.",
  ...
  subList = {
      ...
      new DraggableStandardItem(
          "setUTCTimeValue()",
          "Set the utc time value. The time zone sign can have the values: UTCTimeASN1.[Plus/Minus/GMT]",
  ...
  current = new DraggableStandardItem(
      "UTCTimeASN1()",
      "ASN1 UTCTime node constructor. To be used with 'new'.",
  ...
  subList.clear();
  subList = {
      new DraggableStandardItem("getUTF8StringValue()", "Get the utf8 string value.", "string getUTF8StringValue()"),
      new DraggableStandardItem(
          "setUTF8StringValue()", "Set the utf8 string value.", "void setUTF8StringValue(string value)")};
  current = new DraggableStandardItem(
      "UTF8StringASN1()",
      "ASN1 UTF8String node constructor. To be used with 'new'.",
  ...
  subList = {
      new DraggableStandardItem(
          "Choice callback function template",
          "Template of a function to easily create the callback to pass as argument to the choice constructor.",
          "",
          choiceTemplate),
      new DraggableStandardItem("getSelectedChoice()", "Get the selected object.", "ASN1Object getSelectedChoice()"),
      new DraggableStandardItem(
          "getSelectedChoiceIndex()", "Get the index of the selected object.", "unsigned int getSelectedChoiceIndex()"),
      new DraggableStandardItem("setSelectedChoice()",
                                "Set the choice from index, and returns the created object.",
                                "ASN1Object setSelectedChoice(unsigned int index)"),
      new DraggableStandardItem(
          "makeDummyChoiceList()",
          "Instanciate all the possible choices. This does not set a choice, it only allows the access them as preview.",
          "void makeDummyChoiceList()"),
      new DraggableStandardItem(
          "deleteDummyChoiceList()", "Deletes the dummy list to clean memory.", "void deleteDummyChoiceList()"),
      new DraggableStandardItem(
          "getAvailableChoices()", "Get the number of available choices.", "unsigned int getAvailableChoices()"),
      new DraggableStandardItem("dummyChoiceFromIndex()",
                                "Get the object at index in the dummy list.",
                                "ASN1Object dummyChoiceFromIndex(unsigned int index)")};
  current = new DraggableStandardItem(
      "ChoiceASN1()",
      "ASN1 Choice node constructor. To be used with 'new'.",
  ...
  subList = {
      new DraggableStandardItem(
          "Sequence Array function template",
          "Template of a function to easily create the array to pass as argument to the sequence constructor.",
          "",
          seqTemplate),
      new DraggableStandardItem(
          "getObjectAt()", "Get the object at index.", "ASN1Object getObjectAt(unsigned int index)"),
      ...
      new DraggableStandardItem("getExtensibilityObjectAt()",
                                "Get the object at indexin the extensible part of the sequence.",
                                "ASN1Object getExtensibilityObjectAt(unsigned int index)"),
      new DraggableStandardItem("getExtensibilityeSize()",
                                "Get the number of objects in the extensible part of the sequence.",
                                "unsigned int getExtensibilityeSize()")};
  current = new DraggableStandardItem(
      "SequenceASN1()",
      "ASN1 Sequence node constructor. To be used with 'new'.",
  ...
  subList = {
      new DraggableStandardItem(
          "Sequence Of callback function template",
          "Template of a function to easily create the callback to pass as argument to the sequence of constructor.",
          "",
          seqOfTemplate),
      new DraggableStandardItem(
          "getObjectAt()", "Get the object at index.", "ASN1Object getObjectAt(unsigned int index)"),
      new DraggableStandardItem(
          "getSequenceOfSize()", "Get the number of objects in the sequence of.", "unsigned int getSequenceOfSize()"),
      new DraggableStandardItem(
          "appendNewObject()", "Appends a new object and returns it.", "ASN1Object appendNewObject()"),
      new DraggableStandardItem(
          "deleteObjectAt()", "Deletes the object at index.", "void deleteObjectAt(unsigned int index)"),
      new DraggableStandardItem(
          "moveUpObject()", "Move up the object at index.", "void moveUpObject(unsigned int index)"),
      new DraggableStandardItem(
          "moveDownObject()", "Move down the object at index.", "void moveDownObject(unsigned int index)"),
      new DraggableStandardItem(
          "getNewDummyObject()",
          "Returns an object as it would be made in the sequence of, but it is not added. It is a preview.",
          "ASN1Object getNewDummyObject()"),
  };
  current = new DraggableStandardItem(
      "SequenceOfASN1()",
      "ASN1 Sequence node constructor. To be used with 'new'.",
  ...
  subList = {new DraggableStandardItem(
                 "Set Array function template",
                 "Template of a function to easily create the array to pass as argument to the set constructor.",
                 "",
                 setTemplate),
             new DraggableStandardItem(
                 "getObjectAt()", "Get the object at index.", "ASN1Object getObjectAt(unsigned int index)"),
             ...
             new DraggableStandardItem("getExtensibilityObjectAt()",
                                       "Get the object at indexin the extensible part of the set.",
                                       "ASN1Object getExtensibilityObjectAt(unsigned int index)"),
             new DraggableStandardItem("getExtensibilityeSize()",
                                       "Get the number of objects in the extensible part of the set.",
                                       "unsigned int getExtensibilityeSize()")};
  current = new DraggableStandardItem(
      "SetASN1()",
      "ASN1 Set node constructor. To be used with 'new'.",
...
QGroupBox *UI_GrammarJS::MakeHintPanel(QWidget *parent)
{
  ...
  QObject::connect(HintPanel->selectionModel(),
                   SIGNAL(currentChanged(QModelIndex, QModelIndex)),
                   this,
                   SLOT(RefreshHint(QModelIndex)));
...
{
  QString fileName = QFileDialog::getOpenFileName(this, "Open Script File", "../Grammar", "JavaScript file (*.js *)");
  if (fileName != "")
  {
    QFile f(fileName);
    if (f.exists())
...
void UI_GrammarJS::SaveJSScript()
{
  ...
  QString fileName = QFileDialog::getSaveFileName(this, "Save Script File", defaultFile, "JavaScript file (*.js *)");
  QFile f(fileName);
