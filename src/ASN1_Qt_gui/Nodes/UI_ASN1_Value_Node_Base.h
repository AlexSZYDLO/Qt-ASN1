...
public:                                                                                                                   \
  ...
  bool accept(ASN1_Object *val) override;                                                                                 \
  void MakeWidget(QGroupBox *inBox, bool readOnly) override;                                                              \
  bool GetHexValue(ASN1_Object *val, ByteArray &hex) override;
#endif
...
public:
  UI_ASN1_Value_Node(QWidget *parent)
      : m_ParentWidget(parent)
  {
  }
  virtual ~UI_ASN1_Value_Node() = 0;
