...
static const yytype_uint8 yyprhs[] = {
  0,     0,     3,     4,    12,    14,    15,    17,    19,    22,
  24,    26,    29,    32,    35,    38,    40,    43,    47,    48,
  54,    55,    61,    62,    67,    68,    74,    75,    81,    82,
  87,    90,    91,    93,    95,    96,    98,   102,   106,   108,
  112,   117,   118,   120,   123,   125,   127,   128,   134,   135,
  137,   139,   140,   142,   144,   146,   148,   149,   151,   153,
  155,   157,   159,   161,   163,   165,   167,   169
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] = {
  44,     0,    -1,    -1,     5,    15,    45,    39,     7,    50,
  8,    -1,    50,    -1,    -1,    46,    -1,    47,    -1,    46,
  47,    -1,    48,    -1,    49,    -1,    13,    14,    -1,     9,
  12,    -1,    10,    12,    -1,    11,    12,    -1,    51,    -1,
  50,    51,    -1,     5,    39,    56,    -1,    -1,    61,    53,
  36,    62,    37,    -1,    -1,    24,    54,    36,    63,    37,
  -1,    -1,    23,    55,    60,    66,    -1,    -1,    61,    57,
  36,    62,    37,    -1,    -1,    24,    58,    36,    63,    37,
  -1,    -1,    23,    59,    60,    66,    -1,    71,    70,    -1,
  -1,    21,    -1,    22,    -1,    -1,    64,    -1,    62,    38,
  64,    -1,    62,    38,    42,    -1,    64,    -1,    63,    38,
  64,    -1,     6,    67,    66,    65,    -1,    -1,    20,    -1,
  71,    70,    -1,    52,    -1,     5,    -1,    -1,    40,    69,
  4,    41,    68,    -1,    -1,     9,    -1,    10,    -1,    -1,
  16,    -1,    17,    -1,    18,    -1,    19,    -1,    -1,    26,
...
yyreduce:
  ...
  case 3:
    /* Line 1792 of yacc.c  */
#line 75 "Parser.y"
    { gGen->SetGrammarName(*(yyvsp[(1) - (7)].name)); delete (yyvsp[(1) - (7)].name); gGen->GrammarEnd(); }
    break;
...
#line 99 "Parser.y"
  ...
  case 17:
    /* Line 1792 of yacc.c  */
#line 110 "Parser.y"
    { gGen->AddModule(*(yyvsp[(1) - (3)].name), (yyvsp[(3) - (3)].nodeType)); delete (yyvsp[(1) - (3)].name); }
    break;
...
#line 114 "Parser.y"
  ...
  case 19:
    /* Line 1792 of yacc.c  */
#line 114 "Parser.y"
    { (yyval.vMod) = {gGen->AddUniqueModule((yyvsp[(1) - (5)].nodeType)), (yyvsp[(1) - (5)].nodeType)}; }
    break;
...
#line 120 "Parser.y"
  ...
  case 25:
    /* Line 1792 of yacc.c  */
#line 120 "Parser.y"
    { (yyval.nodeType) = (yyvsp[(1) - (5)].nodeType); }
    break;
...
#line 122 "Parser.y"
  ...
  case 30:
    /* Line 1792 of yacc.c  */
#line 123 "Parser.y"
    { gGen->NewModule(); gGen->AddTempVariable("", (yyvsp[(1) - (2)].nodeType), false); (yyval.nodeType) = (yyvsp[(1) - (2)].nodeType); }
    break;
...
#line 151 "Parser.y"
    {
      gGen->SetLastVariableName(*(yyvsp[(1) - (4)].name));
      gGen->SetLastVariableTag((yyvsp[(2) - (4)].tag));
      gGen->SetLastVarOptional((yyvsp[(4) - (4)].opt));
...
#line 161 "Parser.y"
  ...
  case 43:
    /* Line 1792 of yacc.c  */
#line 165 "Parser.y"
    { gGen->AddTempVariable("", (yyvsp[(1) - (2)].nodeType), false);                            }
    break;

  case 44:
    /* Line 1792 of yacc.c  */
#line 166 "Parser.y"
    { gGen->AddTempVariable(*(yyvsp[(1) - (1)].vMod).name, (yyvsp[(1) - (1)].vMod).type, false); delete (yyvsp[(1) - (1)].vMod).name; }
    break;

  case 45:
    /* Line 1792 of yacc.c  */
#line 167 "Parser.y"
    { gGen->AddTempVariable(*(yyvsp[(1) - (1)].name), cNull, true); delete (yyvsp[(1) - (1)].name);              }
    break;
...
#line 171 "Parser.y"
  ...
  case 47:
    /* Line 1792 of yacc.c  */
#line 172 "Parser.y"
    { (yyval.tag) = {false, (yyvsp[(2) - (5)].tagClass), (yyvsp[(3) - (5)].i), (yyvsp[(5) - (5)].explImpl)}; }
    break;
